class Cutscene1_2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("cutscene", "Cutscene1-2.tmj");   // Tilemap in JSON
    ...
    create() {
        ...
        this.map = this.add.tilemap("cutscene");
        ...
        this.bg3 = this.map.createLayer("Background3", [this.tileset, this.industrialTileset], 0, 0);
        this.bg2 = this.map.createLayer("Background2", [this.tileset, this.industrialTileset], 0, 0);
        this.bg = this.map.createLayer("Background", [this.tileset, this.industrialTileset], 0, 0);
        this.ground = this.map.createLayer("Ground", [this.tileset, this.industrialTileset], 0, 0);
